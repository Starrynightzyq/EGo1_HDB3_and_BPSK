...
connect_bd_intf_net -intf_net xadc_wiz_0_M_AXIS [get_bd_intf_pins ila_1/SLOT_0_AXIS] [get_bd_intf_pins xadc_wiz_0/M_AXIS]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net xadc_wiz_0_channel_out [get_bd_pins ila_2/probe0] [get_bd_pins xadc_wiz_0/channel_out]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xadc_wiz_0/m_axis_tready] [get_bd_pins xlconstant_0/dout]
