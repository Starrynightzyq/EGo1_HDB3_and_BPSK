...
# IP: bd/system/ip/system_ila_3_0/system_ila_3_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_ila_3_0 || ORIG_REF_NAME==system_ila_3_0} -quiet] -quiet

# IP: bd/system/ip/system_tlast_gen_0_0/system_tlast_gen_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_tlast_gen_0_0 || ORIG_REF_NAME==system_tlast_gen_0_0} -quiet] -quiet
